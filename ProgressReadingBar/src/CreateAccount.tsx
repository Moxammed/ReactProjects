...
const CreateAccount = () => {
 return (
  <>
   <div className="flex flex-col justify-center mx-auto max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
     ...
     <div className="flex items-center justify-center mt-6">
      <div>
       ...
       <label className="flex items-center mb-3 space-x-3">
        ...
        />
        <span className="font-normal text-gray-700 dark:text-white">Pink</span>
       </label>
       <label className="flex items-center mb-3 space-x-3">
        <input
         type="checkbox"
        ...
        />
        <span className="font-normal text-gray-700 dark:text-white">Green</span>
       </label>
       <label className="flex items-center mb-3 space-x-3">
        <input
         type="checkbox"
       ...
       <label className="flex items-center mb-3 space-x-3">
        ...
        />
        <span className="font-normal text-gray-700 dark:text-white">Black</span>
       </label>
       <label className="flex items-center mb-3 space-x-3">
        <input
         type="checkbox"
       ...
       <label className="flex items-center mb-3 space-x-3">
        ...
        />
        <span className="font-normal text-gray-700 dark:text-white">Red</span>
       </label>
       <label className="flex items-center mb-3 space-x-3">
        <input
         type="checkbox"
        ...
        />
        <span className="font-normal text-gray-700 dark:text-white">Gray</span>
       </label>
      </div>
     </div>
    </div>

  ...
  <>
   <div className="flex flex-wrap w-full">
    ...
    <div className="w-1/2 shadow-2xl">
     <img
      className="hidden object-cover w-full h-screen pb-8 md:block"
      src="https://uploads-ssl.webflow.com/5b0886c4be77e07a3437bd81/5b0f2d01a975624815fb6a30_newfocus.jpg"
     />
    </div>
   </div>
  </>
...
export default LoginPageDesign2;
